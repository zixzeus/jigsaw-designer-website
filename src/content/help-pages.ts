  ...
  "jigsaw-generation": {
    ...
    "zh-Hans": article("zh-Hans", {
      ...
      sections: [
        ...
        {id: "parameters", title: "设置生成参数并开始", paragraphs: ["在项目信息中设置网格大小、目标片数、最小和最大卡槽距离。确认所选模板和参数后，选择生成拼图。"], image: {src: "/gen_step3-v1-6.webp", alt: "已选择卡槽模板且可开始生成的 JigsawDesigner 编辑器", caption: "确认模板和项目信息中的参数后，再开始生成。"}},
    ...
    "zh-Hant": article("zh-Hant", {
      ...
      sections: [
        ...
        {id: "parameters", title: "設定產生參數並開始", paragraphs: ["在專案資訊中設定網格大小、目標片數、最小與最大卡槽距離。確認所選範本和參數後，選擇產生拼圖。"], image: {src: "/gen_step3-v1-6.webp", alt: "已選擇卡槽範本且可開始產生的 JigsawDesigner 編輯器", caption: "確認範本和專案資訊中的參數後，再開始產生。"}},

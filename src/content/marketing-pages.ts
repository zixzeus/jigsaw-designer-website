...
const pages: Record<MarketingSlug, Record<TierOneLocale, ArticleContent>> = {
  ...
  "how-to-make-a-laser-cut-jigsaw-puzzle": {
    en: article("en", {
      ...
      sections: [
        {id: "prepare-boundary", title: "1. Prepare the outer boundary", paragraphs: ["Create a new project and draw a closed outer contour, or import a suitable SVG boundary. Set the canvas size and check that the intended geometry is visible and selectable."], image: {src: "/generation-ready-v1-6.webp", alt: "A closed puzzle boundary, selected slot template, and generation values ready in JigsawDesigner", caption: "Review the boundary, slot template, and Project Info values before generation."}},
    ...
    "zh-Hans": article("zh-Hans", {
      ...
      sections: [
        {id: "prepare-boundary", title: "1. 准备外边界", paragraphs: ["创建项目并绘制闭合外轮廓，或导入合适的 SVG 边界。设置画布尺寸，确认目标几何可见且可选。"], image: {src: "/generation-ready-v1-6.webp", alt: "JigsawDesigner 中已准备好的闭合拼图边界、所选卡槽模板和生成参数", caption: "生成前检查边界、卡槽模板和项目信息中的参数。"}},
    ...
    "zh-Hant": article("zh-Hant", {
      ...
      sections: [
        {id: "prepare-boundary", title: "1. 準備外邊界", paragraphs: ["建立專案並繪製封閉外輪廓，或匯入合適的 SVG 邊界。設定畫布尺寸，確認目標幾何可見且可選取。"], image: {src: "/generation-ready-v1-6.webp", alt: "JigsawDesigner 中已準備好的封閉拼圖邊界、所選卡槽範本與產生參數", caption: "產生前檢查邊界、卡槽範本與專案資訊中的參數。"}},

        ...
        <div id="features" className="container mx-auto px-6 md:px-12 py-24">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <FeatureCard 
              ...
              description="Built on SVGView library. Edit vector shapes with precision. Circles, rectangles, paths, and polygons supported natively."
            />
            <FeatureCard 
              icon={<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />}
              title="C++ Algorithm Engine"
              description="High-performance generation using OpenCV and Boost. Voronoi diagrams and DCEL structures ensure perfect cuts every time."
            />
            <FeatureCard 
              ...
              description="Seamless experience across macOS, iOS, iPadOS. Design on your Mac, review on your iPad."
            />
          </div>
        </div>
      </main>
